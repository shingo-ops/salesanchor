...
-- ---------------------------------------------------------------------------
INSERT INTO tenant_006.leads (tenant_id, lead_code, customer_name, company_name, email, status, ai_collection_state)
VALUES
    (6, 'QA-LD-001', 'QA Lead New',       'QA Company A', 'qa-lead-new@example.com',       'lead',              'completed'),
    (6, 'QA-LD-002', 'QA Lead Contacted', 'QA Company B', 'qa-lead-contacted@example.com', 'negotiating',       'completed'),
    (6, 'QA-LD-003', 'QA Lead Qualified', 'QA Company C', 'qa-lead-qualified@example.com', 'existing_customer', 'completed'),
    (6, 'QA-LD-004', 'QA Lead Lost',      'QA Company D', 'qa-lead-lost@example.com',      'lost',              'completed'),
    (6, 'QA-LD-005', 'QA Lead Won',       'QA Company E', 'qa-lead-won@example.com',       'existing_customer', 'completed');
