...
| 日付 | PR | 内容 | 状態 |
|------|----|------|------|
| 2026-06-11 | #1932 | 段階1: channel_masters + webhook→conv_logs 配線 + エコー受信 + 冪等 | マージ済み |
| 2026-06-11（本番デプロイ） | #1932 | 段階1 本番反映。並走期間開始 → SA-02-design.md §10 日程表を更新すること | _(デプロイ後記入)_ |
