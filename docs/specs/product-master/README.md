...
- [商品マスタ一覧・詳細編集（DETAIL-01）](../../handoff/tcg-product-import/design.md#2026-09-13-商品詳細編集と二言語一覧detail-01)（2026-09-13、完成条件PO合意・自己審査合格、実装・検証済み、PR3492マージ・公開資産反映済み。ただし配備は既存移行処理と商品名の不整合で停止、完了保留。reconの2026-09-14公開確認節参照）
