...
- `migrations/20260922_040000_fix_phase2c_fk_blocker.sql` — 本PRで追加する修正マイグレーション（020000 は rule-test-system と衝突のため 030000 に変更）
...
- 新マイグレーション `migrations/20260922_040000_fix_phase2c_fk_blocker.sql` で両FK DROP
