...
## 完了済み旧参照の限定比較
main5afb5af1、実DB履歴列・制約を照合。先行7件手修正0、商品単体7/7。design§25のA便非採用比較のみ自己審査APPROVE、B便の本番採用はREVISE。比較3ファイルをClaude担当へ委任。根拠refresh-schema-20260914.json/refresh-pilot-design-proof.json。
