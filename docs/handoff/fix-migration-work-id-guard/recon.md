...
- `public.products.work_id` は `20260916_130000_work_id_not_null.sql` (step 669) で NOT NULL化済み
...
- tenant→public 移行は `20260914_140000_unify_tcg_products_to_public.sql` が正式に担当
