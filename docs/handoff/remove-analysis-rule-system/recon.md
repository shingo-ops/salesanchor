...
- ADR-154 (TCG analysis pipeline SSOT) — 本 PR は analysis_rule サブシステムを tcg_status_master 統合により廃止
...
- `frontend/src/locales/ja.json` — analysisRules.tabs/soldOut/dateRule 削除
