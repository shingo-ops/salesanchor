...
1. 便1（窓口3本新設）: 完了。PR #2788 マージ済み（mergedAt 2026-07-05）。
   scripts/ledger-lookup.sh:1-30 / ledger-update.sh:1-45 / ledger-view.sh:1-35 が実在。
2. 便2（読者・更新者の付け替え）: 完了。PR #2792/#2794/#2797 マージ済み。
   呼び出し実測: register-pr.sh:66 / cleanup-worktree.sh:53-55 /
   reaper-worktree.sh:138,304-306 / gh-pr-merge-safe.sh:70 / validate-pr-ownership.sh:82。
3. 窓口の読み書き先: .d/優先→本体フォールバックの二段構え
   （lookup:16-29 / update:17-25 / view:13-33）。ただし置き場
...
4. 便3-1（書き手の切替）: PR #2939 マージ済み（mergedAt 2026-07-18T10:26:27Z・
   ...
   .gitkeep で置き場常設＋new-worktree.sh の登録先を .d/ へ切替。
