...
## 根拠
- `scripts/run_all_migrations.sh:657-662`: 実行順 = 20260914_140000 → 20260922_040000 → 20260915_010000 → 20260915_120000
- `migrations/20260915_120000_phase_b_fk_rewire_uuid_to_int.sql:18-26`: Phase Bはtenant_%のみループ、public.*は非対象

## 既存の型ガードパターン（ADR参照）
- `migrations/20260914_140000_unify_tcg_products_to_public.sql:333-401`: Phase 2aのStep 3で全4テーブルに _pid_typid <> _uuid_oid ガードを実装済み
- `migrations/20260915_120000_phase_b_fk_rewire_uuid_to_int.sql:267-272`: Phase Bも同様のガード実装
