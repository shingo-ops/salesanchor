...
- scripts/run_all_migrations.sh:661 に 20260915_010000_drop_tcg_products_phase2c の登録がある
...
- Phase 2a (20260914_140000_unify_tcg_products_to_public) は public.products(tcg_uuid) への UNIQUE 制約 uq_products_tcg_uuid を作成するはずだった
...
- scripts/run_all_migrations.sh:524 — 20260922_050000_fix_phase2c_fk_drop_only（analysis_results FK 修正）
- scripts/run_all_migrations.sh:661 — 20260915_010000_drop_tcg_products_phase2c（問題のブロック箇所）
