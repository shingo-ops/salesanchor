...
| `frontend/src/pages/deals/DealsPage.tsx:88-366` | `/deals` 一覧・作成・編集・削除のページ本体 |
| `frontend/src/pages/deals/DealEditPage.tsx:61-195` | `/deals/:id/edit` の個別編集ページ本体 |
| `frontend/src/pages/deals/DealFormFields.tsx:28-71` | DealsPage / DealEditPage で共有されるフォーム部品 |
