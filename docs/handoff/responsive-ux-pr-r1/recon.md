...
| `frontend/src/locales/ja.json` | nav.openMenu キー追加 |
| `frontend/src/locales/en.json` | nav.openMenu キー追加 |
...
- `frontend/src/company-forms.css:194` の @media (max-width: 768px) はスコープ外。別 PR で対応。
