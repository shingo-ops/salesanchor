...
- ファイル: `frontend/src/pages/super-admin/components/AnalysisRulesSidebar.tsx`（84-112行）
...
- ファイル: `frontend/src/locales/ja.json`（3973-3977行）
- `statusMaster: "ステータスマスタ"`, `conditionsMaster: "状態マスタ"`, `unitMaster: "単位マスタ"`

### en.json（analysisRules.sidebar）
- ファイル: `frontend/src/locales/en.json`（3973-3977行）
- `statusMaster: "Status Master"`, `conditionsMaster: "Condition Master"`, `unitMaster: "Unit Master"`

### パネルtitle
- ja: `unitMaster.title: "単位マスタ"`, `statusMaster.title: "ステータスマスタ"`, `conditionsMaster.title: "状態マスタ"`
- en: `unitMaster.title: "Unit Master"`, `statusMaster.title: "Status Master"`, `conditionsMaster.title: "Condition Master"`
