...
| `backend/app/services/tcg_analyzer_svc.py` | SSOT 照合ロジック（_match_status_pattern:1077） |
...
`backend/app/services/tcg_analyzer_svc.py` の `_match_status_pattern`（line 1077）:
- DEFAULT → 常に True
