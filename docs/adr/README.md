...
| [ADR-116](./ADR-116-main-deploy-stamp.md) | ADR-116: main デプロイ成功スタンプ | Accepted | — | — |
...
| [ADR-146](./ADR-146-discord-gateway-single-bot-routing.md) | ADR-146: Discord受信を「共通bot1台＋guild_id振り分け」(B方式)へ全面移行する | Proposed | — | — |
