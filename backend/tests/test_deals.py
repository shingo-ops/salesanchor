...
class TestDealsCRUD:
    ...
    async def test_list_deals(self, client):
        ...
        await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "案件A",
        })
        await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "案件B",
        })
    ...
    async def test_list_deals_filter_by_company(self, client):
        ...
        await client.post("/api/v1/deals", json={
            "lead_id": lead_a, "company_id": company_a, "contact_id": contact_a, "title": "Aの案件",
        })
        await client.post("/api/v1/deals", json={
            "lead_id": lead_b, "company_id": company_b, "contact_id": contact_b, "title": "Bの案件",
        })
    ...
    async def test_get_deal(self, client):
        ...
        create_res = await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "詳細テスト案件",
        })
    ...
    async def test_update_deal_status(self, client):
        ...
        company_id, contact_id, lead_id = await _create_company_contact(client)
        create_res = await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "進行中",
        })
        deal_id = create_res.json()["id"]
    ...
    async def test_update_deal_with_date_and_amount(self, client):
        ...
        company_id, contact_id, lead_id = await _create_company_contact(client)
        create_res = await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "日付更新テスト",
        })
        deal_id = create_res.json()["id"]
    ...
    async def test_delete_deal(self, client):
        ...
        company_id, contact_id, lead_id = await _create_company_contact(client)
        create_res = await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "削除案件",
        })
        deal_id = create_res.json()["id"]
    ...
    async def test_delete_deal_with_order_returns_409(self, client):
        ...
        deal_res = await client.post("/api/v1/deals", json={
            "lead_id": lead_id, "company_id": company_id, "contact_id": contact_id, "title": "注文紐付け商談",
        })
