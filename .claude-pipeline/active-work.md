...
| release/field-size-leads | リードの操作台に寸法金型を適用 | 2026-07-21 | IN_PROGRESS | | main | base=origin/main・frontend/leads |
| release/toolbar-edge-4px | 操作台の最右ボタンに4px右余白を金型化 | 2026-07-21 | IN_PROGRESS | | main | base=origin/main・frontend/content-toolbar |
...
| release/lessons-guard-enforce | lessons-guard.yml/design.md予約 | 2026-07-21 | IN_PROGRESS | | main | |
