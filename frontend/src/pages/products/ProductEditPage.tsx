    ...
    api
      ...
      .then((prod) => {
        ...
        setForm({
          ...
          product_kind: prod.product_kind || "TCG",
          tcg_type: prod.tcg_type || "",
          set_type: prod.set_type || "",
          ...
          jan_code: prod.jan_code || "",
          card_number: prod.card_number || "",
          expansion_code: prod.expansion_code || "",
          rarity: prod.rarity || "",
          language: prod.language || "",
          unit_price_usd: prod.unit_price_usd != null ? String(prod.unit_price_usd) : "",
          unit_price_eur: prod.unit_price_eur != null ? String(prod.unit_price_eur) : "",
          image_url: prod.image_url || "",
          boxes_per_case: prod.boxes_per_case != null ? String(prod.boxes_per_case) : "",
          packs_per_box: prod.packs_per_box != null ? String(prod.packs_per_box) : "",
          box_weight_kg: prod.box_weight_kg != null ? String(prod.box_weight_kg) : "",
          case_weight_kg: prod.case_weight_kg != null ? String(prod.case_weight_kg) : "",
          volume_weight: prod.volume_weight != null ? String(prod.volume_weight) : "",
          moq: prod.moq != null ? String(prod.moq) : "",
          hs_code: prod.hs_code || "",
          material: normalizeMaterial(prod.material || ""),
          item: prod.item || "",
          required_output_value: prod.required_output_value || "",
          search_keywords: prod.search_keywords || "",
          exclude_keywords: prod.exclude_keywords || "",
          related_series: prod.related_series || "",
          category_classification: prod.category_classification || "",
        });
      })
      .catch((e) => {
