...
function eventMatchesOwnerFilter(item: ScheduleItem, visibleOwnerIds: number[]) {
...
function staffName(staff: Pick<StaffRow, "surname_jp" | "given_name_jp" | "primary_email" | "staff_code">) {
