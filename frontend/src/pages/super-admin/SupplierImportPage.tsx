...
function SupplierImportPanel({ onDone }: { onDone: () => void }) {
  ...
  async function doPreview() {
    ...
    try {
      setPreview(await api.postForm<PreviewResponse>("/super-admin/suppliers/import/preview", form));
    } catch (e) {
  ...
  async function doCommit() {
    ...
    try {
      setResult(await api.postForm<CommitResponse>("/super-admin/suppliers/import/commit", form));
      setPreview(null);
    } catch (e) {
