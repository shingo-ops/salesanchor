/**
 * Country list SSOT (ADR-126 Section 3).
 *
 * Country name (EN), ISO 3166-1 alpha-2 code, and international dial code.
 * Used by both the Country combobox and the Telephone country code combobox.
 *
...
/** Lookup map: alpha-2 code -> CountryEntry */
