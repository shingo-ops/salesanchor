...
|------|------|------|---------|-----|------|
| Geminiの商品マスタ参照・作品IDのみ判断 | 設計担当 | 新729明細対照不一致0。単一投稿診断RuntimeError、Clientの通信前closeをAPIなしで再現 | Client保持の限定修正設計自己APPROVE・カード発行。実装承認待ち、採用/配信0 | design-keyword.md §17.12 / reconClient寿命 / CARD-LINE-WORK-CLIENT-04 | 2026-09-13 |
