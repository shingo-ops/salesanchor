...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | 専用ブランチでAPI・クライアント実装、単体6＋16成功。本番未反映 | CI・レビュー後にAPI導入、端末認証と実送信試験 | Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
