...
| Geminiの商品マスタ参照・作品IDのみ判断 | 設計担当 | PR3481配備済み。カードセット改訂2:個別3既存/集合1追加設計、商品28/28・境界58/58 | カード08を明示された実装担当へ引継ぎ。PR3483旧版のGO待ちは撤回、改訂後再検証 | 本番READ ONLY / recon改訂2 / CARD-LINE-CARDSET-08 / PR3462 | 2026-09-13 |
