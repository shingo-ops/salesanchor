...
|------|------|------|---------|-----|------|
| 商品CSVとmigration再実行の分離設計 | 設計パートナー | 方針PO合意済み。最新main233登録・間接32SQL/固定名11不一致/補完5差/初期DDL制約差を確認。切替REVISE | 限定検証委任を受領、70d145f起点でtest1本作成中。静的確認→検証PR/実CI。切替未着手 | EV-20260914-PRODUCT-MIGRATION-SEPARATION / docs/handoff/tcg-product-import/recon.md 同日分離調査 | 2026-09-14 |
