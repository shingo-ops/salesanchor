...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | PR #3443本番反映済み。端末login導入、30テスト成功。実認証待ち | Termuxでlogin、認証成功後に送信有効化・実送信試験 | PR #3443 / Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
