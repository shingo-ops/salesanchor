...
| Geminiの商品マスタ参照・作品IDのみ判断 | 設計/実装担当 | PR3481マージ/配備済み。9種セット対策PR3483、正式CI3295成功/95skip | PR3483の番号付きGO待ち。再解析/採用/配信は未実施 | PR3481 merge6326115c / Deploy34750745805 / PR3483 / recon本番反映節 | 2026-09-13 |
