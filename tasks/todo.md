...
|------|------|------|---------|-----|------|
| 解析結果・配信の共通並び順 | Agent | PR #3501・負荷試験4097行の解析GETが10秒で停止。3720成功/追加1失敗、実装検収保留 | 統計整備でも上限外一括取得は失敗。公開API上限500/100と配信全件を別検証。未反映 | EV-20260914-TCG-RESULT-ORDER / docs/handoff/pmg-import-delivery-ssot/design.md RESULT-ORDER | 2026-09-14 |
