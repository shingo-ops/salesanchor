...
| 商品マスタ詳細編集・二言語一覧 | CI待ち | PR #3492提出済み。UI18件・単体343件・build/静的検査成功。実PG進行中、正式GOゲート未充足 | 実PG/全CI確認→番号付きGO記録→正規マージ/配備 | PR #3492 / docs/handoff/tcg-product-import/recon.md / EV-20260913-PRODUCT-DETAIL | 2026-09-14 |
