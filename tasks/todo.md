...
| GOフロー統一（既存GO転記テーマの延長） | 設計担当 | PR #3440未マージ。H1単独hook REJECT。送信側5主体/8手順/S01〜S10設計、mainの配備経路・rules実物照合、全体REVISE | 制御/配備主体の配置と権限差分を具体化。元入力捕捉/base競合/実権限未確立、実装カード未発行 | docs/handoff/go-record-transcription/recon.md §2026-09-13 送信側拒否条件の照合 / EV-20260912-GO-ACTIVATION-DESIGN | 2026-09-13 |
