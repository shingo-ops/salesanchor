...
| GOフロー統一（既存GO転記テーマの延長） | 設計担当 | 設計草案PR #3418提出済み・全体REVISE。L1 #3404はdf3c2a47でマージ・本番反映確認済み。予約/失敗返却/緊急優先/委任範囲を設計へ反映 | 予約の抽象モデル333状態/639遷移を限定検証。本人識別・再実行/24時間境界を具体化。委任開始時の本人操作案、認可の根の分離・復旧枠が残件。L1完了 | PR #3418、PR #3404、EV-20260910-L1-3404-DEPLOYED、deploy run34478228420 | 2026-09-10 |
