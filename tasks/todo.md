...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | PR #3443 Draft。単体6＋16・CI 2,608成功/95 skip。本番未反映 | レビュー・PR番号付きGO後にAPI導入、端末認証と実送信試験 | PR #3443 / Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
