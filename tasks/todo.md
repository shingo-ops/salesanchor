...
| GOフロー統一（既存GO転記テーマの延長） | 設計担当 | PR #3440未マージ。制御/記録repo分離・資格5主体/配備切替6手順を草案化、既定復帰維持。設定GET403、全体REVISE | 入力受付と非本番権限検証の依存関係を分け最小診断を設計。採用承認/実権限/費用未確定、実装なし | docs/handoff/go-record-transcription/recon.md §2026-09-13 制御と配備の配置照合 / EV-20260912-GO-ACTIVATION-DESIGN | 2026-09-13 |
