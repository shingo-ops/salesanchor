...
|------|------|------|---------|-----|------|
| 解析結果・配信の共通並び順 | Agent | 8状態順PO合意・設計自己審査APPROVE。3経路の実装と実PG試験コード作成、静的検査成功 | 正式CIで実PG/ページ/内容保持を検証。未マージ・本番未反映。絞り込みは後続 | EV-20260914-TCG-RESULT-ORDER / docs/handoff/pmg-import-delivery-ssot/design.md RESULT-ORDER | 2026-09-14 |
