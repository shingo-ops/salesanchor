...
| 商品マスタ詳細編集・二言語一覧 | 実装/公開担当 | PR3492マージ・公開資産反映、CI3647成功。配備は既存登録処理PM0264名称不一致で失敗、health正常 | 現在名を維持する既存移行処理の限定修正へ範囲判断。配備全体の完了は保留 | PR3492 / deploy34794455633 / docs/handoff/tcg-product-import/detail-production-verification.json | 2026-09-14 |
