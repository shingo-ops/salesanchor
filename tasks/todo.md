...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | PR #3443本番反映済み。PR #3445に送信専用キー実装。実DB含むCI 2,625成功/95 skip。未反映 | PR #3445 GO・本番反映後、管理者初回登録・保存済み原本の実送信 | PR #3443 / Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
