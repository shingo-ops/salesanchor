...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | PR #3443本番反映済み。端末直接loginは接続元制限で停止。33テスト成功 | Webで初回端末認可する方式への変更確認。実送信未完了 | PR #3443 / Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
