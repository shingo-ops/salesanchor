...
|------|------|------|---------|-----|------|
| Android LINE専用API・Termux送信 | Codex | PR #3443本番反映済み。端末専用APIキー実装。フロント後回し、管理者登録経路と実DBテスト追加 | CI・実DB検証後、本番反映・管理者による初回端末登録・実送信 | PR #3443 / Issue #3437 / docs/handoff/line-android-import/recon.md | 2026-09-12 |
