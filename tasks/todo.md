...
| PMG進捗画面の見やすさ改善 | root / Codex Terra | 認知負荷の設計指針と実物照合、表示設計は自己審査APPROVE | 正式カード検査後Terra実装、状態試験・PC/390px視覚確認 | EV-20260911-PMG-VISUAL-HIERARCHY / docs/handoff/pmg-import-delivery-ssot/design.md | 2026-09-11 |
