...
| タスク | 担当 | 現在地 | 次の一手 | 根拠 | 更新日 |
|------|------|------|------|------|------|
| ワンピース商品追加・解析対策 | 設計・実装担当 | 空箱本番反映済み。25th複合除外の範囲追加をPO承認、設計§17改訂6合格/カード再発行 | 既存PR #3475で新セット/プロモの複合除外追加と実PG再検証。マージ/本番反映/再解析/配信対象外 | PR #3475 / design-keyword §17改訂6 / recon「複合除外の承認・再開」 | 2026-09-13 |
