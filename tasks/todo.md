...
|------|------|------|---------|-----|------|
| Chromatic CI 削除 | Agent | `.github/workflows/chromatic.yml` を削除する小PRを準備中。Chromatic Snapshot / UI Tests を workflow から外し、残る視覚ゲート（Karte / ADR-067 / Storybook）を維持する | recon/design を置いて PR 起票 → GO記録を入れて develop へ反映し、#2507 を rebase して UI Tests pending 解消を確認する | `.github/workflows/chromatic.yml` / `docs/handoff/remove-chromatic-ci/recon.md` / `docs/handoff/remove-chromatic-ci/design.md` | 2026-06-23 |
