...
|------|------|------|---------|-----|------|
| 解析結果・配信の共通並び順 | Agent | PR #3501マージd29c1ab5。CI3763成功/95skip。配備34918739146はコード工程成功・既存migrationの商品ID取得で失敗 | 旧商品表削除後のmigration再実行互換を棚卸し・復旧。稼働API正常、実データ順序未検収 | EV-20260914-TCG-RESULT-ORDER / docs/handoff/pmg-import-delivery-ssot/design.md RESULT-ORDER | 2026-09-15 |
