...
|------|------|------|---------|-----|------|
| 解析結果・配信の共通並び順 | Agent | PR #3501・GO原文受領済み。CI3750成功/95skip、限定検収APPROVE。別件PR3503本番migration失敗で反映停止 | Deploy34810423329失敗の復旧確認後、最新main/CIを再照合。未マージ・本番未反映 | EV-20260914-TCG-RESULT-ORDER / docs/handoff/pmg-import-delivery-ssot/design.md RESULT-ORDER | 2026-09-14 |
